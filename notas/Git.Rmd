...
usando el conector ssh apropiado, es decir, vayan al [repo de prueba](https://github.com/skalas/repo-prueba) y vayan a la sección de
...
```{bash eval=FALSE}
git clone https://github.com/<usuario_github>/repo-prueba.git
```
