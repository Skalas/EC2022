...
folder `/Users/miguel.escalante/github/EC2022/notas/`. En R también es posible navegar a partir de
...
load(file = "./notas/R/ejemplo.RData") #la extensión puede ser arbitraria.
ls()
```
...
```{r}
set.seed(2887)
respuestas <- sample(x = c(1:5), size = 6, replace =  T)
respuestas 
y <- factor(
  x = respuestas,
  levels = c("1", "2", "3", "4", "5"),
